...
public class MyRestResponse extends ActionResponse implements ToXContentObject {
  final org.apache.logging.log4j.Logger logger = Loggers.getLogger(getClass());

  private final Exception exception;

  public MyRestResponse(Exception e) {
    this.exception = e;
  }
  ...
  public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
    logger.info("__________________ : myrest reponse ......... ");
    builder.startObject();
    if (exception == null) {
